...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
    <p style="line-height: 140%;">Here is your information from recent application</p>
  </div>
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
    <p style="line-height: 140%;">cyusa@mail.com</p>
  </div>
...
export default async function mailer({ receiver, data }: MailerProps) {
  const info = await transporter.sendMail({
    from: '"Rica via Irembo👻" <iankhevin@gmail.com>', // sender address
    to: `${receiver}`, // list of receivers
    subject: "Confirmation Of Application", // Subject line
    text: "Hello world?", // plain text body
    html: getTemplate(data), // html body
  });
